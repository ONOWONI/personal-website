        ...
        <div className="home background">
            <div className="home-container">
                <Textdiv>
                    ...
                    <p>Hi there! My name is Daniel and I am a <span className="large-text">Backend Developer</span> with a passion for creating efficient and scalable web applications. I have developed a strong skill set in languages such as Python and JavaScript, as well as backend technologies like Django and Flask.</p>
                    ...
                    <p>In my free time, you can usually find me tinkering with personal <span className="large-text">projects</span> or Nerding out over the latest tech news. I'm always down to chat about programming or just hang out, so don't be shy! Feel free to shoot me a message or connect with me on <a href="https://linkedin.com/in/daniel-onowoni" className="text-link">LinkedIn.</a></p>
                </Textdiv>
