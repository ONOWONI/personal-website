        ...
        <Fullpage>
            ...
            <FullPageSections >
                <FullpageSection>
                    ...
                    <a href={cv} id='cv' target="_blanc">Download CV</a>
                    <div className="left-card project-card">
                        ...
                        <div className="project-text">
                            ...
                            <p className='bottom-text'>Check it Out <a href='https://poultry-plus.onrender.com' className='out-link' target="_blanc" >here</a></p>
                ...
                <FullpageSection>
                    <div className="right-card project-card not-first">
                        <div className="project-img">
                            <img src={img2} alt="Home screen of project" />
                        </div>
                        <div className="project-text">
                            <h1>Djurnal</h1>
                            ...
                            <p className='bottom-text'>Check It Out <a href='https://djurnal.onrender.com' className='out-link' target="_blanc" >here</a></p>
                ...
                <FullpageSection>
                    <div className="left-card project-card not-first">
                        ...
                        <div className="project-text">
                            ...
                            <p className='bottom-text'>Check out Poolinc <a href='https://poolinc.netlify.app/' className='out-link' target="_blanc" >here</a></p>
